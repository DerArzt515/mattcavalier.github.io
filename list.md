...
Play Summary (from We Didn&rsquo;t Playtest This At All)
...
Each game, players will use a random set of Kingdom Builder cards (3 of 10), special actions (4 of 8), and terrain sectors to build the map (4 of 8), ensuring you won&rsquo;t play the same game twice!
...
<tr>
<td class="org-left">Mechanics</td>
<td class="org-left">Area Majority / Influence</td>
</tr>


<tr>
<td class="org-left">&#xa0;</td>
<td class="org-left">Chaining</td>
</tr>
...
During a game of Carcassonne, players are faced with decisions like: &ldquo;Is it really worth putting my last meeple there?&rdquo; or &ldquo;Should I use this tile to expand my city, or should I place it near my opponent instead, giving him a hard time to complete their project and score points?&rdquo; Since players place only one tile and have the option to place one meeple on it, turns proceed quickly even if it is a game full of options and possibilities.
...
<tr>
<td class="org-left">&#xa0;</td>
<td class="org-left">Tile Palacement</td>
</tr>
</tbody>
</table>
...
The forces of evil are threatening to overrun Hogwarts castle in Harry Potter: Hogwarts Battle, a cooperative deck-building game, and it&rsquo;s up to four students to ensure the safety of the school by defeating villains and consolidating their defenses. In the game, players take on the role of a Hogwarts student: Harry, Ron, Hermione or Neville, each with their own personal deck of cards that&rsquo;s used to acquire resources.
...
<tr>
<td class="org-left">&#xa0;</td>
<td class="org-left">Novel-based</td>
</tr>
</tbody>
...
To get others to guess &ldquo;milk&rdquo;, for example, the team might place the question mark icon (which signifies the main concept) on the liquid icon, then cubes of this color on the icons for &ldquo;food/drink&rdquo; and &ldquo;white&rdquo;. For a more complicated concept, such as &ldquo;Leonardo DiCaprio&rdquo;, the team can use the main concept and its matching cubes to clue players into the hidden phrase being an actor or director, while then using sub-concept icons and their matching cubes to gives clues to particular movies in which DiCaprio starred, such as Titanic or Inception.
...
<tr>
<td class="org-left">Mechanics</td>
<td class="org-left">Communication Limits</td>
</tr>
...
Bourre (pronounced &ldquo;boo-ray&rdquo;) is a trick-taking card game similar to Spades. It is widely played in Louisiana, particularly within the Cajun culture and on the off-shore oil platforms near the Louisiana Gulf Coast.

Bourre uses a standard 52-card deck. Players ante up and are dealt a five card hand. They may then &ldquo;fold&rdquo; or continue, swapping out up to all five cards (in some variants they will re-ante to play a hand). The rules are fairly straightforward:
(from Wikipedia entry):

1.  You must play to win. This goes beyond simply &ldquo;playing a higher card&rdquo;; if you know that no one else has any trumps, and it is your turn to lead, you must play trumps if you have them.
...
At the end of the round, the person with the most tricks, takes the pot. If there is a tie, the pot stays in for the next round. If one of the players who played a hand did not take any tricks at all, he is said to have &ldquo;bourreed&rdquo; and must match the pot as his ante for the next round. Needless to say, the pot can get quite large, especially with larger groups playing.
...
<tr>
<td class="org-left">Mechanics</td>
<td class="org-left">Trick-taking</td>
</tr>
</tbody>
</table>
...
This gambling game is popular in Louisiana, USA. Although it is a trick-taking game unrelated to Poker, it has become known to Poker players in North America as an alternative choice in home Poker games. The game is of French origin. It is a descendant of Bourre, a three-card game which was popular in southwest France in the early 20th century, which was probably descended in turn from the Spanish game Burro (&ldquo;donkey&rdquo;). In the French game a player who plays and takes no tricks is said to be &ldquo;bourré&rdquo;, and it is this term that gives its name to the Louisiana game Bourré, which is sometimes spelled with just one &rsquo;r&rsquo;: (bouré). Sometimes this is altered to &ldquo;bourre&rdquo; or &ldquo;boure&rdquo; by American writers unfamiliar with French accents, and often it is written &ldquo;booray&rdquo; or &ldquo;boo-ray&rdquo; which in American spelling approximates the French pronunciation of bourré.
...
Any player who wishes to may shuffle and the dealer has the right to shuffle last. The cards must then be cut by the player to dealer&rsquo;s right.

The dealer deals out the cards one at a time, starting with the player to dealer&rsquo;s left and continuing clockwise until each player has five cards. Cards are dealt face down, except for the dealer&rsquo;s fifth and last card, which is dealt face up. The suit of this card indicates the trump suit.
...
Beginning with the player to dealer&rsquo;s left, each player in clockwise order must declare whether he or she will pass or play, and if playing, how many cards he or she wishes to discard.
...
The player to dealer&rsquo;s left, or if this player has passed, the next player in clockwise rotation who is playing, leads to the first trick. Thereafter the winner of each trick leads to the next.
...
1.  Players must always &ldquo;follow suit&rdquo; if able to - that is, all but the first to play to a trick must play a card of the same suit as the card that was led.
...
If the dealer is playing, the dealer&rsquo;s card that was dealt face up to determine the trump suit counts as belonging to the dealer&rsquo;s hand (except in the very unusual case that the dealer chose to discard it) and is played in accordance with the rules of play above.
...
When you are required to play your &ldquo;highest&rdquo; trump because your hand is a cinch, the play of an adjacent trump - such as the King from Ace-King or the Jack from King-Jack when the Queen has already been played - is acceptable.
...
If there is a tie for most tricks (when the tricks divide 2-2-1, and in the rare case of five players taking one trick each) no one takes the pot. This is known as a &ldquo;split pot&rdquo; but the pot is not shared out - it remains for the next deal and the new antes and any penalties are added to it.

Anyone who plays and takes no trick is said to have gone &ldquo;bourré&rdquo;. These players must pay an amount equal to the whole contents of the pot. This payment forms part of the pot for the next deal.
...
1.  Double Ante
    ...
    Some play that the decisions whether or not to play and how many cards to draw are separated into two separate rounds. First each player in turn declares either &ldquo;play&rdquo; (paying a second ante of one chip) or &ldquo;pass&rdquo;. After everyone has declared, there is a second round in which those who decided to play discard cards if they wish and are dealt replacements.

2.  Separate Trump Card
    ...
    2.  The turned up trump can be taken by the dealer if he or she decides to play. The dealer effectively has six cards; if for example the dealer discards four cards and elects to use the turned up trump, three replacement cards will be dealt to make up the dealer&rsquo;s five-card hand.
...
One player (&ldquo;God&rdquo;, &ldquo;Nature&rdquo; or the &ldquo;Demiurge&rdquo;) thinks up a rule (a &ldquo;law of nature&rdquo;) that governs the correct play of the cards. Usually, the rule only involves the most recently correctly-played card, but it can be more complex.

The other players (&ldquo;Scientists&rdquo;) take turns playing cards (&ldquo;performing experiments&rdquo;) and race one another to see who can come up with a good hypothesis about the rule. The first player to correctly deduce the rule scores big; God also scores based on how long it took for the players to figure the rule out. God should not choose a rule that is so hard to find out that nobody does, because then he doesn&rsquo;t score.

Additionally, a player with an hypothesis can declare himself to be a &ldquo;prophet&rdquo; who can predict the results of the other player&rsquo;s experiments. Other players can then try to bring about the overthrow of the prophet by trying to find experiments whose results cannot be predicted (falsification), thus gaining a chance to become prophet themselves.

A very simple rule would be &ldquo;Alternate between black and red cards&rdquo;. A simple but hard to discover rule would be &ldquo;Alternate between cards which have closed loops in their number or letter designations (e.g. 4, Q), and cards which don&rsquo;t (e.g. 2, K)&rdquo;.

The game was first published in Martin Gardner&rsquo;s Scientific American column in June 1959. A revised version appeared in Gardner&rsquo;s October 1977 Scientific American column.
...
<tr>
<td class="org-left">Play Time</td>
<td class="org-left">40 - 60 Min</td>
</tr>
</tbody>
...
<tr>
<td class="org-left">&#xa0;</td>
<td class="org-left">Educational</td>
</tr>
</tbody>
...
2.  The Play
    ...
    1.  Player (Scientist):
        ...
        1.  Play a card from your hand. (Usually it&rsquo;s best to play a card you think is right.) If you feel confident, you may play a sequence of 2, 3, or 4 cards. If you think you have no \`\`right&rsquo;&rsquo; card, you may declare \`\`no play&rsquo;&rsquo; and show your hand to everyone.
        2.  Just after you play (any play, regardless of consequences), if you think you know the rule, you may declare yourself Prophet, provided: (1) there isn&rsquo;t already a prophet, (2) you haven&rsquo;t already been prophet this round, and (3) there are still two or more players besides yourself and the dealer.
    
    2.  Dealer (God):
    
        1.  If there is no prophet, call each play \`\`right&rsquo;&rsquo; or \`\`wrong,&rsquo;&rsquo; and give two penalty cards for each \`\`wrong&rsquo;&rsquo; card. A sequence of 2 to 4 cards is right only if each card played sequentially would be right. Give two penalty cards for each card in a wrong sequence. Don&rsquo;t tell which card or cards made the sequence wrong.
        2.  If there is a prophet, s/he makes the calls, and you \`\`approve&rsquo;&rsquo; or \`\`disapprove&rsquo;&rsquo; each call. If you disapprove a call, overthrow the prophet and give him/her 5 penalty cards; the player (scientist) who just played gets no penalty for a wrong play.
        3.  Put a white marker on each 10th card played, and call a \`\`sudden death&rsquo;&rsquo; period after 40 cards played. During sudden death, any player who makes a wrong play is expelled. (When there is a prophet, sudden death is based only on the black markers.)
    ...
    3.  Prophet:
        ...
        2.  Take over the job of calling plays \`\`right&rsquo;&rsquo; or \`\`wrong&rsquo;&rsquo;&#x2013;carefully!
        3.  Put a black marker on every 10th card played after you became prophet, and call a \`\`sudden death&rsquo;&rsquo; period after 30 cards played.
        4.  If overthrown, pick up your cards and resume your role as a player.
        
        **Special Rule:**
            A player who correctly claims \`\`no play&rsquo;&rsquo; puts his cards on the table and is dealt a new hand with 4 fewer cards (this may put the player out and end the round). If the player is wrong, Prophet or Dealer plays a correct card from the hand and deals the player a 5 card penalty. [But if prophet calls incorrectly, the card is returned to the player&rsquo;s hand without penalty, and Prophet is overthrown.]

3.  ENDING

    A round ends when either (1) some player runs out of cards, or (2) all players have been expelled for wrong plays during \`\`sudden death&rsquo;&rsquo; period. The game ends when everyone has been dealer once (but you can end earlier).
...
4.  SCORING
    ...
    4.  Dealer&rsquo;s score is the smaller of (a) the highest player&rsquo;s score, or (b) twice the number of cards played before the True Prophet started.
...
New Eleusis is a simulation of scientific research. The general idea is that the dealer (in the role of \`\`God&rsquo;&rsquo; or \`\`Nature&rsquo;&rsquo;) thinks up a rule that governs the correct play of the cards. The other players (\`\`Scientists&rsquo;&rsquo;) take turns playing cards (\`\`performing experiments&rsquo;&rsquo;) and race one another to see who can come up with a good theory about the rule. The first player with a theory can declare himself/herself to be a \`\`prophet&rsquo;&rsquo; who can predict the results of the other player&rsquo;s experiments. Other players then try to bring about the overthrow of the prophet by trying to find experiments whose results cannot be predicted (thus gaining a chance to become prophet themselves).

![img](./eleusis_image.gif)
...
-   The game doesn&rsquo;t work well for four or fewer people. More than eight can play, but the game gets too long and individual players don&rsquo;t get enough chances to experiment.
...
-   If you give a hint, make sure it isn&rsquo;t misleading. For example, don&rsquo;t say \`\`suits don&rsquo;t matter&rsquo;&rsquo; if your rule depends on the color of the card.
...
-   If a rule makes almost all plays correct, or almost all plays incorrect, it&rsquo;s too hard.
...
-   Generally, of course, you want to play \`\`correct&rsquo;&rsquo; cards. But if you have a theory, often you can best test it by playing cards that you think are incorrect.
-   If you have a theory, but there is already a Prophet, look for special cases that you aren&rsquo;t quite sure about. If the Prophet has the same theory, you may be able to overthrow him/her.
-   Your best \`\`think time&rsquo;&rsquo; is when it is someone else&rsquo;s turn, so you don&rsquo;t feel hurried.
-   Don&rsquo;t spend too much time thinking when only a few cards have been played.
...
-   You may announce at the end of someone else&rsquo;s turn that you wish to become prophet. Then, beginning with the player who just played and proceeding clockwise, each player in turn has the opportunity to become Prophet. If no one else elects to do so, you become Prophet immediately.
